...
phase5_files() {
  ...
  for F in listener.py send.py memory.py skills.py sessions.py cron_runner.py redact.py reid.py \
           migrate_tokens.py vaultwarden.py platform_compat.py secretstore.py servicemgr.py providers.py persona.py claude_health.py triggers.py verify_loop.py embeddings.py skillguard.py updater.py audit_log.py; do
